...
import com.banglog.auth.application.service.CompleteTempUserService;
import com.banglog.auth.application.service.GetCurrentAuthUserService;
import com.banglog.auth.application.service.LoginWithProviderService;
...
class AuthUseCaseServicesTest {
	...
	void logsInExistingFullUserByProviderId() {
		...
		userRepository.save(User.create(existingUser.getId(), "banglog"));
	...
	void returnsCurrentProfileForFullUser() {
		...
		userRepository.save(User.create(fullUser.getId(), "banglog"));
	...
	private static final class InMemoryUserQueryRepository implements UserQueryRepository {
		...
		@Override
		public com.banglog.user.domain.view.UserSearchView searchUsersByNickname(String nickname, int page, int size) {
