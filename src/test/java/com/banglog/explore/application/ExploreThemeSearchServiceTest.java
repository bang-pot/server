...
import com.banglog.explore.application.service.ExploreThemeSearchReader;
import com.banglog.explore.application.service.GetExploreFiltersService;
import com.banglog.explore.application.service.GetExploreThemesService;
...
class ExploreThemeSearchServiceTest {
	...
	void setUp() {
		...
		getExploreFiltersUseCase = new GetExploreFiltersService(new ExploreFiltersReader(repository));
	}
