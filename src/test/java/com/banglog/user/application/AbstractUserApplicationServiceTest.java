...
import com.banglog.user.application.service.CheckNicknameAvailabilityService;
import com.banglog.user.application.service.CompletedUserAccessService;
import com.banglog.user.application.service.GetMyCreatedMeetingsService;
import com.banglog.user.application.service.GetMyCalendarService;
import com.banglog.user.application.service.GetMyFavoriteThemesService;
import com.banglog.user.application.service.GetMyFavoriteThemesSummaryService;
import com.banglog.user.application.service.GetMyMeetingLogsService;
import com.banglog.user.application.service.GetMyJoinedMeetingsService;
import com.banglog.user.application.service.GetMyCrewsService;
import com.banglog.user.application.service.GetMyPendingCrewsService;
import com.banglog.user.application.service.GetMyProfileService;
import com.banglog.user.application.service.GetMyWithdrawalCheckService;
import com.banglog.user.application.service.SearchUsersService;
import com.banglog.user.application.service.WithdrawMyAccountService;
import com.banglog.user.application.service.UpdateMyProfileService;
...
abstract class AbstractUserApplicationServiceTest {
	...
	protected static final class InMemoryUserQueryRepository implements UserQueryRepository {
		...
		@Override
		public com.banglog.user.domain.view.UserProfileView findMyProfileUserViewByUserId(Long userId) {
			return userRepository.findById(userId)
				.map(user -> com.banglog.user.domain.view.UserProfileView.of(
					user.getId(),
					user.getNickname(),
	...
	protected static final class InMemoryMeetingQueryRepository implements MeetingQueryRepository {
		...
		@Override
		public java.util.List<com.banglog.meeting.domain.view.CrewMeetingGalleryDetailView.Photo> findCrewMeetingGalleryDetailPhotos(
			Long meetingId
		) {
		...
		@Override
		public java.util.Optional<com.banglog.meeting.domain.view.MeetingsAccessView> findMeetingsAccessViewByCrewIdAndUserId(
			Long crewId,
			Long userId
		) {
			throw new UnsupportedOperationException();
		...
		@Override
		public com.banglog.meeting.domain.view.MeetingsView findMeetingsViewByCrewId(Long crewId, int page, int size) {
			throw new UnsupportedOperationException();
		}

		@Override
		public java.util.Optional<com.banglog.meeting.domain.view.MeetingDetailView> findMeetingDetailView(
			Long crewId,
			Long meetingId,
			Long userId
		) {
	...
	protected static final class InMemoryCrewQueryRepository implements CrewQueryRepository {
		...
		public com.banglog.crew.domain.view.MeetingCreateCrewsView findActiveCrewsByUserId(Long userId) {
			return com.banglog.crew.domain.view.MeetingCreateCrewsView.of(List.of());
		}

		@Override
		public List<com.banglog.user.domain.view.MyWithdrawalCheckView.BlockingActiveCrew> findWithdrawalBlockingActiveCrewsByMemberUserId(Long userId) {
			return crewRepository.findActiveByMemberUserId(userId).stream()
				.map(crew -> com.banglog.user.domain.view.MyWithdrawalCheckView.BlockingActiveCrew.of(
					crew.getId(),
					crew.getName()
				))
				.toList();
	...
	protected static final class InMemoryCrewMemberRepository implements CrewMemberRepository {
		...
		public boolean existsLeaderByCrewIdAndUserId(Long crewId, Long userId) {
			return findByCrewIdAndUserId(crewId, userId)
				.filter(crewMember -> crewMember.getRole() == com.banglog.crew.domain.CrewRole.LEADER)
				.isPresent();
		}
	...
	protected static final class InMemoryCrewJoinRequestQueryRepository implements CrewJoinRequestQueryRepository {
		...
		@Override
		public java.util.Optional<com.banglog.crew.domain.view.CrewJoinRequestManagementAccessView>
			findManagementAccessByCrewIdAndUserId(Long crewId, Long userId) {
			throw new UnsupportedOperationException();
		}

		@Override
		public com.banglog.crew.domain.view.CrewJoinRequestsView findCrewJoinRequestsViewByCrewId(
			Long crewId,
			int page,
			int size
		) {
		...
		@Override
		public com.banglog.crew.domain.view.PendingCrewJoinRequestsView findPendingCrewJoinRequestsViewByCrewId(
			Long crewId,
			int page,
			int size
		) {
	...
	protected static final class InMemoryMeetingLogQueryRepository implements MeetingLogQueryRepository {
		...
		@Override
		public java.util.Optional<com.banglog.meeting.domain.view.MyMeetingLogView> findMyMeetingLogView(
			Long meetingId,
			Long authorUserId
		) {
			return java.util.Optional.empty();
		...
		@Override
		public java.util.Optional<com.banglog.meeting.domain.view.MeetingLogDetailView> findMeetingLogDetailView(
			Long crewId,
			Long logId
		) {
			return java.util.Optional.empty();
	...
	protected static final class InMemoryUserWithdrawalRepository
		implements com.banglog.user.application.port.UserWithdrawalRepository {
