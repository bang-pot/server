...
public class GetMyJoinedMeetingsService implements GetMyJoinedMeetingsUseCase {
	...
	private final JoinedMeetingReadRepository joinedMeetingReadRepository;
	...
	public Result handle(Query query) {
		...
		JoinedMeetingReadRepository.SearchResult searchResult = joinedMeetingReadRepository.search(
			user.getId(),
			query.page(),
			query.size()
		);
