...
import com.banglog.explore.domain.ThemeFavorite;
...
interface ThemeFavoriteJpaRepository extends JpaRepository<ThemeFavorite, Long> {
	...
	@Query("""
		select new com.banglog.explore.domain.view.MyFavoriteThemesView$Item(
			tf.themeId,
			t.name,
			s.name,
			s.region,
	...
	@Query("""
		select new com.banglog.explore.domain.view.MyFavoriteThemesSummaryView$Item(
			tf.themeId,
			t.name,
			s.name,
			s.region,
